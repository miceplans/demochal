...
export class OrdersService {
  ...
  async markPaid(id: string) {
    return this.db.transaction((tx) => this.payOrder(tx, id));
  }

  /** Caller-supplied transaction so payment can commit atomically with a related write. */
  async payOrder(tx: DbTx, id: string) {
